...
### Task Requirements
As a professional Python programmer, please against the [Misuse Rule List] analyze the [Source Code] for Cryptographic API misuse detection.
...
5. Once [Source Code] analyze is complete, then Output the Detection Result following the Output Format.
...
# def batch_analyze(folder_path: str, codetype: str, model_name: str, i):
    ...
    # Save result to CSV
    output_csv = Path(folder_path) / f"analysis_result_by_{model_name.replace('/', '_')}-{i}-3.csv"
